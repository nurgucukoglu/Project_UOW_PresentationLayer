...
using Project_UOW_BusinessLayer.Concrete;
using Project_UOW_DataAccessLayer.Abstract;
using Project_UOW_DataAccessLayer.Concrete;
using Project_UOW_DataAccessLayer.EntityFramework;
...
namespace Project_UOW_PresentationLayer
{
    public class Startup
    {
        ...
        {
            //DI da constructor kullanabilmek için yazýyorum.
